...
export default function AlisIadeFaturaPrintPage() {
    ...
    >
      ...
      <Box sx={{ mb: 3, p: 2, bgcolor: '#f8f9fa', borderRadius: 1 }}>
        ...
        <Stack direction="row" spacing={3}>
          <Box sx={{ flex: 1 }}>
            <Typography variant="body2"><strong>Tedarikçi Kodu:</strong> {fatura.cari.cariKodu}</Typography>
      ...
      <Box sx={{ p: paperSize === 'A4' ? 4 : 2 }}>
        ...
        <Box sx={{
          ...
          <Stack direction="row" spacing={3}>
            <Box sx={{ flex: 1 }}>
              <Typography variant="body2" sx={{ color: '#666' }}>
                <strong>Tedarikçi Kodu:</strong> {fatura.cari.cariKodu}
              </Typography>
            </Box>
            <Box sx={{ flex: 1 }}>
              {fatura.cari.telefon && (
